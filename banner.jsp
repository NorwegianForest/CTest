	      ...
	      <table width="960" border="0" align="center">
	        <tr>
	          <td><ul id="MenuBar1" class="MenuBarHorizontal">
	            <li><a href="/CTest2.4/index.jsp">首页</a>              </li>
	            <li><a href="#" class="MenuBarItemSubmenu">登录</a>
	              <ul>
	                <li><a href="/CTest2.4/user_login.jsp">学生登录</a></li>
	                <li><a href="/CTest2.4/register.jsp">注册新用户</a></li>
	                <li><a href="/CTest2.4/login.jsp">管理员登录</a></li>
	              </ul>
	            </li>
	            <li><a class="MenuBarItemSubmenu" href="#">在线学习</a>
	              <ul>
	                <li><a href="/CTest2.4/materials.jsp?file_name=c-tutorial">学习资料</a></li>
	                <li><a href="/CTest2.4/chapters.jsp">章节试题</a></li>
	                <li><a href="/CTest2.4/simulation.jsp">模拟试题</a></li>
	                <li><a href="/CTest2.4/olds.jsp">历年真题</a></li>
	              </ul>
	            </li>
	            <li><a href="#">模考训练</a></li>
	          ...
	          <%String username = (String)session.getAttribute("username"); 
				if (username == null || "".equals(username)) {
					out.print("<a href=\"/CTest2.4/user_login.jsp\">尚未登录</a>");
				} else {
					out.print("用户：" + username + "&nbsp;&nbsp;");
					out.print("<a href=\"/CTest2.4/personal.jsp\">[个人中心]</a>");
				}
