...
<%@ include file = "banner.jsp" %>
	<div class="container">
	  ...
	  <h2>编辑章节试题</h2>
	  <a href="/CTest2.4/add_exercise.jsp?paper_title=<%=paper_title %>">[添加题目]</a>
	  
	  <form name="edit_paper" action="/CTest2.4/edit_paper" method="post">
			<%
			...
			<fieldset>
				...
				<a href="/CTest2.4/delete_exercise.jsp?exercise_id=<%=rs.getString("exercise_id") %>" onclick="{if(confirm('确定删除吗?')){return true;}return false;}">[删除本题]</a>
			</fieldset>
			<p>
			<%orderNumber++;} %>
