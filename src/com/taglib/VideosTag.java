		...
		try {
			...
			if (pageNumber > 1) {
		  	...
		  	while(rs.next() && row < 5) {
		  		...
		  		out.print("<a href=\'video.jsp?path=" + rs.getString("youku_path") + "\' ><img src=\"/CTest2.4/images/timg (1).jpg\" alt=\"insert logo\" name=\"Insert_logo\" width=\"160\" height=\"120\" id=\"Insert_logo\" style=\"background-color: #B0C4DE; display:block;\" />" + rs.getString("video_title") + "</a>");
		  		out.print("</td>");
		  		if (col == 3) {
		  			out.print("</tr>");
		  			row ++;
