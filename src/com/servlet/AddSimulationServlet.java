...
/**
 * Servlet implementation class AddSimulationServlet
 */
@WebServlet("/AddSimulationServlet")
public class AddSimulationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSimulationServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher requestDispatcher = request.getRequestDispatcher("/edit_simulation.jsp?title=" + tableName);			
